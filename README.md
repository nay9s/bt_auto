...
## ชื่อโปรเจค : ระบบร้านซ่อมรถ
### 1. นายณรงค์กรณ์ ต๊ะสุ 67026214 
(รูปเล่มรายงานครั้งที่ 1 / Frontend : Register , Login / Backend : ทั้งหมด / README.md)

### 2. นายณัฐวุฒิ กล้าจริง 67021725 
(รูปเล่มรายงานครั้งที่ 2 / Frontend : Frontend : ลูกค้า(Admin) , ใบสั่งซ่อม(Admin) , สินค้า(Admin))

### 3. นายพัชรพล ชัยโย 67021972 
(Frontend : หน้าแรก(User) , หน้าหลัก(User) , สถานะรถ(User) , ประวัติบริการ(User) , ติดต่ออู่(User))
...
#3. หากต้องการปิดการใช้งานใช้คำสั่ง `docker compose down`

# คู่มือผู้ใช้งาน
#1. การเข้าสู่ระบบ สิทธิ์ผู้ดูแลระบบสามารถเข้าได้โดยใช้
`Username : admin`
`Password : Admin1234.`

#2. สามารถเข้าสู่ระบบของ User โดยใช้
`Username : 098777666`
`Password : 098777666`
หากเข้าสู่ระบบของ Admin อยู่จำเป็นที่จะต้องกลับไปยังหน้าแรกแล้วเข้าไปยัง Login แล้วจะนำทางไปยังหน้า Home จะมีปุ่มออกจากระบบข้างๆรูปโปรไฟล์ของ User
